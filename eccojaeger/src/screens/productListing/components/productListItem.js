    ...
    <View style={styles.itemContainer}>
      <View style={styles.itemCard}>
        <View style={styles.itemInfo}>
          ...
          {authState?.signIn?.data?.data?.tokenNumber &&
            <Pressable
              style={styles.addBuying}
              onPress={() => network?.isConnected ? props.handleAddBuying(props?.item?.id, unitPrice?.id) : alert(strings.common.offlineMessage)}>
              <FastImage
                style={[styles.productAdd]}
                resizeMode="contain"
                source={StarIcon} />
        ...
        <View style={styles.itemActions}>
          <View style={styles.unitBox}>
            <CustomUnitPrice
              ...
              unitPrice={unitPrice}
              // unitPriceName={`${unitPrice?.name} (${unitPrice?.unitPrices})`}
