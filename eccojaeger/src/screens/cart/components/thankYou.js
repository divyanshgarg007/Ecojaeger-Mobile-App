...
export default function ThankYou(props) {
  return (
    <Overlay
      ...
      <View>
        <Text style={styles.thankyouHead}>
          {strings.common.thankyoufororder}
        </Text>
        <Text style={styles.thankyouText}>{strings.common.clickonme}</Text>
      </View>
      <CustomButton
        title={strings.common.orderHistory}
        buttonStyle={[styles.btnGreen, styles.spaceButton]}
        titleStyle={styles.titleLight}
        onPress={() => props.handleOrderHistory()}
      />
    </Overlay>
  );
}
